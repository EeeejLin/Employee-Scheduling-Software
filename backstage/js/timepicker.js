...
var content = $('<div class="timepicker">\
        <div v-show class="title">請選擇</div>\
            <div class="chose-all">\
                <div class="handle">\
                ...
                <div class="text">\
                    <div class="cell-4"><a class="js-hour-show" title="選擇時"></a></div>\
                    <div class="cell-2">:</div>\
                    <div class="cell-4"><a class="js-minute-show" title="選擇分"></a></div>\
                </div>\
                <div class="handle">\
...
timepicker.bindEvent = function () {
    ...
    thisTimePicker.hourShow.on('click',function() {
        ...
        thisTimePicker.title.text('請選擇小時');
    });
    ...
    thisTimePicker.minuteShow.on('click',function() {
        ...
        thisTimePicker.title.text('請選擇分鐘');
    });
};
