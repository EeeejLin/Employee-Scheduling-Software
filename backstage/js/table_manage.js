        ...
        if (options !== null) {
            ...
            **/
            ...
            if (
                ...
                // div num rows
                var numrowsDiv =
                    '<div class="flex jus-end" style="margin-top:20px;"><div id="for_numrows" class="for_numrows" style="display: inline;"><label for="numrows">' +
                    translate(voc_show_rows) +
                    ': </label><select id="numrows"></select></div></div>';
